package com.gordan.framework.db.dao;

import android.content.ContentValues;
import android.content.Context;

import com.gordan.framework.db.SqliteHelper;
...
public class NewsDao extends SqliteHelper<TB_News>
{
    ...
    public List<TB_News> getAllNews(String[] columns, String selection, String[] selectionArgs)
    {
        return super.queryAllList(mContext, TB_News.class,TB_NAME,columns,selection,selectionArgs);
    }

    public List<TB_News> getNewsBySql(String sql)
    {
    ...
    public int deleteNews(String whereClause, String[] whereArgs)
    {
     ...
     * @return 返回收影响的行数
     */
    public int updateNews(ContentValues values, String whereClause, String[] whereArgs)
    {
        return super.update(mContext,TB_NAME,values,whereClause,whereArgs);
    }

    public long insertNews(TB_News bean)
    {
